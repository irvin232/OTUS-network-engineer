...
```
В Cisco packet tracer на всех маршрутизаторах нет ipv6 dhcp relay. 
В EVE-NG разобраться не удалось пока. 
Поэтому проверить нет возможности. 
Но должно все работать.
```
