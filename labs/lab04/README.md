...
### Часть 1: Разработаем и задокументируем адресное пространство для лабораторного стенда.
  ...
  ac10:ffff::/48 - для каждого сегмента выделяем посеть с /64 префиксом. MGMT адреса на каждом устройстве в последнем актете сопадает с цифрой в имени оборудования.
...
VPC1|eth0|IPv4|192.168.0.4|192.168.0.0/24|Пользовательская сеть  Москва для VPC1
VPC1|eth0|IPv6|autoconfig|ac10:ffff:0:10b1::/64|Пользовательская сеть  Москва для VPC1
VPC7|eth0|IPv4|192.168.1.4|192.168.1.0/24|Пользовательская сеть  Москва для VPC7
VPC7|eth0|IPv6|autoconfig|ac10:ffff:0:10c1::/64|Пользовательская сеть  Москва для VPC7
VPC8|eth0|IPv4|192.168.2.2|192.168.2.0/24|Пользовательская сеть  Москва для VPC8
VPC8|eth0|IPv6|autoconfig|ac10:ffff:0:2b42::/64|Пользовательская сеть  Москва для VPC8
VPC|eth0|IPv4|192.168.3.2|192.168.3.0/24|Пользовательская сеть  Москва для VPC
VPC|eth0|IPv6|autoconfig|ac10:ffff:0:2c42::/64|Пользовательская сеть  Москва для VPC
VPC30|eth0|IPv4|192.168.4.2|192.168.4.0/24|Пользовательская сеть  Москва для VPC30
VPC30|eth0|IPv6|autoconfig|ac10:ffff:0:30b3::/64|Пользовательская сеть  Москва для VPC30
VPC31|eth0|IPv4|192.168.5.2|192.168.5.0/24|Пользовательская сеть  Москва для VPC31
VPC31|eth0|IPv6|autoconfig|ac10:ffff:0:30c3::/64|Пользовательская сеть  Москва для VPC31
